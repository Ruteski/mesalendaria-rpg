...
case "$1" in
    ...
    suporte)
        ...
        echo "2. Reinicie o foundry (./jarvis reiniciar)"
        echo "3. Tente acessar pelo IP: $(curl -s ifconfig.me):30000"
        echo "4. Se por IP funcionou o problema e com o dominio. Veja se o apontamento esta certo. Refaca o processo."        
        echo
    ;; 
    update)
        echo "======================"
        ...
        rm jarvis
        curl -H 'Cache-Control: no-cache' -o jarvis https://raw.githubusercontent.com/ruteski/mesalendaria-rpg/master/scripts/oraclecloud/jarvis.sh?$(date +%s)
        chmod +x jarvis
        echo "----------------------"
        grep -m1 "VERSION=" jarvis
        echo "======================"
    ;;     
    espaco)
        echo "======================"
    ...
    ;;   
    sobre)
      curl -o md https://raw.githubusercontent.com/ruteski/mesalendaria-rpg/master/scripts/logo.txt && cat md && rm md
    ;;      
    compactar)
    ...
    admin)               
        case "$2" in
            ...
            *)
            ...
            echo "Exemplo de uso: ./jarvis admin removesenha"
            echo
    ...
    caddy)
      case "$2" in
        ...
        config)
          ...
          curl -o Caddyfile https://raw.githubusercontent.com/ruteski/mesalendaria-rpg/master/scripts/caddy/Caddyfile.txt
